...
# at NORMALIZED_DATA_DIR/{page}.{section}.ndjson and one entry in NORMALIZED_DATA_MANIFEST_FILE.
PAGE_SECTIONS = {
...
NORMALIZED_DATA_MANIFEST_FILE = NORMALIZED_DATA_DIR / 'manifest.json'  # per (page, section) extraction status
